This project represents my profile which was created using Create React with Visual Studio Code.
Within my project, you will be able to view other projects that I have contributed to Github along with a Weather API under the API structure. 
My React project is very user friendly which also allows you to stay on my page while opening different tabs along the way.
Inside my react project you will find my projects, resume, API page and a contact demo page.
